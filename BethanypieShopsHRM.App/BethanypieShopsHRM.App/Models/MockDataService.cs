...
namespace BethanyPieShopHRM.App.Models
{
    public class MockDataService
    {
        public static List<Employee> employees = default!;
        public static List<JobCategory> jobCategories = default!;
        public static List<Country> countries = default!;

        public static List<Employee> Employees
        {
            get
            {
                countries ??= InitializeMockCountries();

                jobCategories ??= InitializeMockJobCategories();

                employees ??= InitializeMockEmployees();
